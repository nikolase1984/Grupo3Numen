...
const Imagenconboton = () => {
  return (
    <div className="flex flex-col flex-wrap items-center w-screen bg-grey md:flex-row">
      <div className="h-auto font-serif italic md:w-1/2 md:h-auto">
        ...
        <button className="w-auto h-auto mb-10 text-xs duration-300 bg-violet md:hover:scale-105 hover:ease-linear md:text-lg md:mt-12">
